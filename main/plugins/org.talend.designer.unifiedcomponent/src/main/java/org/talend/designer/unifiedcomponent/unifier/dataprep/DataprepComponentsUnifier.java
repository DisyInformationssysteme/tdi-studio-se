...
//
// ============================================================================
package org.talend.designer.unifiedcomponent.unifier.dataprep;
...
public class DataprepComponentsUnifier extends AbstractComponentsUnifier {
    /*
     * (non-Javadoc)
     *
    ...
    public String getDisplayName() {
        return Messages.getString("DataprepComponentsUnifier.lbl.OnPremises");
    }
